...
const dataArray = {
  ...
  proyects: [
    ...
    },
    {
      Key: "3",
      Tittle: "PokeSite",
      Description: "Api Guía de pokemones",
    ...
    },
    {
      Key: "4",
      Tittle: "DSRG",
      Description: "Generador de reporte de la estructura de tu base de datos, para OS windows",
      Tegnologys: [
        "WindowsForms",
        "Telerik report",
    ...
    },
    {
      Key: "5",
      Tittle: "DaJ",
      Description: "Una librería para NodeJs que te permite manejar datos en tu aplicación, estos datos se guardan en el sistema como archivos un codificados a binario.",
      Tegnologys: [
        "Node js",
        "Json",
        "js-guid"
      ],
      Repositorys: ["https://github.com/LuisEduardoFrias/DaJ.git"],
    },
    {
      Key: "6",
      Tittle: "HttpC",
      Description: "HttpC is a node.js package for test the endpoint in un server with Express middleware.",
      Tegnologys: [
        "Node js",
        "express",
        "ejs",
      ...
      Repositorys: ["https://github.com/LuisEduardoFrias/HttpC.git"],
    },
    {
      Key: "7",
      Tittle: "Store_be",
      Description: "Es un api con express, en el cual implementos los proyectos de HttpC y DaJ.",
      Tegnologys: [
        "Node js",
        "express",
        "HttpC",
      ...
      Repositorys: ["https://github.com/LuisEduardoFrias/store_be.git"],
    },
    {
      Key: "8",
      Tittle: "MyProfile",
      Description: "Una pagina web estatica.",
      Tegnologys: [
        "Html5",
        "Css3",
        "Vanilla Java Scriptt",
      ],
      Repositorys: ["https://github.com/LuisEduardoFrias/MyProfile.git"],
    },
  ],
  educations: [
    {
...
function add_experience_page(gate) {
   //
...
function view_experience_page(data, gate) {
   const { Div, ViewData, Label, Button } = Ui;
                  ...
                  () => {
                     handleUrl.changePage({
                        target: { href: "/add/experience" },
                                ...
                                (obj) => controller_experience.delete(gate, obj.Key)
               ),
            ],
...
function add_proyect_page(gate) {
   //
   const { Div, Label, Button, Input, Form } = Ui;
   let countRepo = 1;
   let countTern = 1;
...
function view_proyect_page(data,gate) {
   const { Div, ViewData, Label, Button } = Ui;
         ...
         Div(
            [
               ...
               ViewData(
                  ...
                  (obj) => controller_proyect.delete(gate, obj.Key)
               ),
            ],
...
function add_education_page(gate) {
   //
...
function view_education_page(data, gate) {
   const { Div, ViewData, Label, Button } = Ui;
...
function add_reference_page(gate) {
   //
   const { Div, Label, Button, Input, Form } = Ui;
   //
   return Form([
...
function view_reference_page(data, gate) {
   const { Div, ViewData, Label, Button } = Ui;
